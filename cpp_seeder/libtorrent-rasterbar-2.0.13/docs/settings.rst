...
| name             | type   | default  |
+==================+========+==========+
| peer_fingerprint | string | -LT20D0- |
+------------------+--------+----------+
...
.. _proxy_send_host_in_connect:

.. raw:: html

	<a name="proxy_send_host_in_connect"></a>

+----------------------------+------+---------+
| name                       | type | default |
+============================+======+=========+
| proxy_send_host_in_connect | bool | false   |
+----------------------------+------+---------+
...
.. _disk_disable_copy_on_write:

.. raw:: html

	<a name="disk_disable_copy_on_write"></a>

+----------------------------+------+---------+
| name                       | type | default |
+============================+======+=========+
| disk_disable_copy_on_write | bool | false   |
+----------------------------+------+---------+
...
.. _allow_multiple_connections_per_pid:

.. raw:: html

	<a name="allow_multiple_connections_per_pid"></a>

+------------------------------------+------+---------+
| name                               | type | default |
+====================================+======+=========+
| allow_multiple_connections_per_pid | bool | false   |
+------------------------------------+------+---------+
...
.. _i2p_inbound_length_variance:

.. _i2p_outbound_length_variance:

.. raw:: html

	<a name="i2p_inbound_length_variance"></a>
	<a name="i2p_outbound_length_variance"></a>

+------------------------------+------+---------+
| name                         | type | default |
+==============================+======+=========+
| i2p_inbound_length_variance  | int  | 0       |
+------------------------------+------+---------+
| i2p_outbound_length_variance | int  | 0       |
+------------------------------+------+---------+

Configures the variance for I2P inbound and outbound tunnel lengths [-7..7]

.. _natpmp_lease_duration:

.. raw:: html

	<a name="natpmp_lease_duration"></a>

+-----------------------+------+---------+
| name                  | type | default |
+=======================+======+=========+
| natpmp_lease_duration | int  | 3600    |
+-----------------------+------+---------+
