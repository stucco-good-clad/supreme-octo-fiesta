...
.. _disk.file_pool_hits:

.. _disk.file_pool_misses:

.. raw:: html

	<a name="disk.file_pool_hits"></a>
	<a name="disk.file_pool_misses"></a>

+-----------------------+---------+
| name                  | type    |
+=======================+=========+
| disk.file_pool_hits   | counter |
+-----------------------+---------+
| disk.file_pool_misses | counter |
+-----------------------+---------+
...
.. _disk.file_pool_thread_stall:

.. raw:: html

	<a name="disk.file_pool_thread_stall"></a>

+-----------------------------+---------+
| name                        | type    |
+=============================+=========+
| disk.file_pool_thread_stall | counter |
+-----------------------------+---------+
...
.. _disk.file_pool_race:

.. raw:: html

	<a name="disk.file_pool_race"></a>

+---------------------+---------+
| name                | type    |
+=====================+=========+
| disk.file_pool_race | counter |
+---------------------+---------+
